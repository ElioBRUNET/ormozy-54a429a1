    ...
    return (
      <div className="relative inline-flex items-center justify-center group">
        ...
        <button
          ref={ref}
          className={cn(
            "relative inline-flex items-center justify-center rounded-md bg-gray-900 px-8 py-3 text-lg font-semibold text-white transition-all duration-200 hover:bg-gray-800 hover:shadow-lg hover:-translate-y-0.5 hover:shadow-gray-600/30",
            className
          )}
          {...props}
        >
